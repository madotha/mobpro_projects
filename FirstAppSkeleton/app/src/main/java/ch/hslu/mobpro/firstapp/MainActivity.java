...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int MY_REQUEST_CODE = 23; // Arbitrary / random number
    ...
    public void startLogActivity(View v) {
        Intent logactivity = new Intent(this, LifecycleLogActivity.class);
    ...
    public void startQuestionActivity(View v) {
        ...
        question.putExtra("question", "Und, wie läuft\'s so mit der Androidprogrammierung bis jetzt?");
        startActivityForResult(question, MY_REQUEST_CODE);
    }
